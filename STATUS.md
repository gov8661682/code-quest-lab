...
- Latest deployed milestone runtime: `9da1d0e` (`Add local profile transfer and combat readability`); local hardening commits `5db6db5` and `3e33470` are pushed to `origin/main` but not deployed because they are minor follow-ups. Prior stable runtime `32d83d0` and control-record commit `194bcc5` remain in history. The local follow-up adds verified session-transient UI cleanup, supported-surface combat evidence, first-combat target placement, and the gated developer QA aid.
...
- Latest local verification: `npm.cmd run release:verify` passed with 63 Node tests, a 17-file build including deterministic `build-info.json`, and the static-package audit; `npm.cmd run native:sync` passed. The unreleased local shell and mirror share SHA-256 `8168D9973A05946D49AF7FB53454FD9584C25C25CE22DA2C10F07661BF6498E7`; the deployed checkpoint remains `3A39EF4158EA494523FE04323D5D40BAA082E4C09F526A499707C3656EF139DA` until the next major milestone.

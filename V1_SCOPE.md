...
The release candidate must meet every item in `RELEASE_CRITERIA.md`, with no open P0/P1 issue and with every remaining human-only action named in `OWNER_ACTIONS.md`.

...
// Codex and desktop tooling may open the project through the convenience
// junction at Desktop\Codex\Joey's Game. Capacitor derives generated native
// dependency paths from the working directory, so always run it from the
// real Git repository path. This keeps generated Android/iOS files portable
// and avoids apostrophe-bearing junction paths leaking into Gradle/Swift.
...
run('npm', ['run', 'build']);
run('npx', ['cap', 'sync', ...process.argv.slice(2)]);
